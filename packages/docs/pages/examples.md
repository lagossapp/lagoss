We have set up many examples using different libraries and frameworks. Each example has a `lagoss-dev` script that uses [`lagoss dev`](/cli#lagoss-dev) to start the example locally, in a few seconds.
