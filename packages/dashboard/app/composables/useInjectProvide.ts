...
export function inject<T extends keyof InjectKeys>(key: T, required: true): InjectKeys[T];
export function inject<T extends keyof InjectKeys>(key: T, required: false): InjectKeys[T] | undefined;
export function inject<T extends keyof InjectKeys>(key: T, required = true): InjectKeys[T] | undefined {
